  ...
  return (
    <div className="space-y-8 pb-20 max-w-7xl mx-auto relative z-10">
      ...
      <motion.div 
        ...
        className="relative overflow-hidden rounded-[2.5rem] bg-[#050A15] p-6 md:p-8 shadow-2xl shadow-blue-900/20 border border-white/10"
      >
        <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[var(--color-brand-blue)]/30 blur-[80px] rounded-full translate-x-1/3 -translate-y-1/2 pointer-events-none"></div>
        <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-[var(--color-brand-orange)]/20 blur-[60px] rounded-full -translate-x-1/4 translate-y-1/3 pointer-events-none"></div>
